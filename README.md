...
Include the [template](https://github.com/MAD-I-T/gitlab-ci-magento/blob/main/.magento-actions-full-template.yml) (ie `.magento-actions-full-template.yml`) in your `.gitlab-ci.yml`
